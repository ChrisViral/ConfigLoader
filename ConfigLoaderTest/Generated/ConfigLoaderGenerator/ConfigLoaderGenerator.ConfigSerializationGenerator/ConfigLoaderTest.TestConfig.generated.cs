        ...
        public void LoadFromConfig(ConfigNode node)
        {
            ...
            for (int i = 0; i < valueCount; i++)
            {
                ...
                switch (value.name)
                {
                    ...
                    case "intList":
                    {
                        if (ParseUtils.TryParse<List<int>, int>(value.value, out List<int> _intList, ParseUtils.TryParse, ParseOptions.Defaults))
                        {
                    ...
                    case "stringHashSet":
                    {
                        if (ParseUtils.TryParse<HashSet<string>, string>(value.value, out HashSet<string> _stringHashSet, ParseUtils.TryParse, ParseOptions.Defaults))
                        {
                    ...
                    case "longLinkedList":
                    {
                        if (ParseUtils.TryParse<LinkedList<long>, long>(value.value, out LinkedList<long> _longLinkedList, ParseUtils.TryParse, ParseOptions.Defaults))
                        {
